...
Как я использую AI-инструменты в документации и не передаю им ответственность за факты, терминологию и продуктовую логику.

## Принцип

AI ускоряет черновую работу. Финальное решение остается за автором.
...
На выходе получается набор проверяемых артефактов:
...
AI уже стал частью работы технического писателя. Ценность специалиста — в контроле качества:
