...
Пример пайплайна доставки документации: от Markdown-файла до опубликованного портала.

## Что решает пайплайн

Docs as Code нужен, когда документация обновляется вместе с продуктом:
...
Такой процесс превращает страницу в управляемый артефакт:
