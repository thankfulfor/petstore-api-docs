...
Рабочий процесс документации в продуктовой команде: от задачи в трекере до публикации и обратной связи.

## Цель процесса

Документация идет вместе с разработкой, а не догоняет релиз.

В процессе фиксируются:

- письменные договоренности;
- связь документации с задачами и релизами;
- проверка контента до публикации;
- владелец страницы и порядок обновления;
...
Моя сильная зона — превращать разрозненные вводные в рабочий процесс:
